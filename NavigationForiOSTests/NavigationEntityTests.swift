...
class NavigationEntityTests: XCTestCase {
    ...
    override func setUp() {
        ...
        beaconThresholdList1.append(BeaconThreshold(minor_id: 4, threshold: -70))
        beaconThresholdList1.append(BeaconThreshold(minor_id: 5, threshold: -75))
        beaconThresholdList1.append(BeaconThreshold(minor_id: 6, threshold: -80))
        beaconThresholdList1.append(BeaconThreshold(minor_id: 7, threshold: -70))
        beaconThresholdList1.append(BeaconThreshold(minor_id: 8, threshold: -75))
        beaconThresholdList1.append(BeaconThreshold(minor_id: 9, threshold: -80))
        var beaconThresholdList2: [BeaconThreshold] = []
        beaconThresholdList2.append(BeaconThreshold(minor_id: 1, threshold: -70))
        beaconThresholdList2.append(BeaconThreshold(minor_id: 2, threshold: -75))
        beaconThresholdList2.append(BeaconThreshold(minor_id: 3, threshold: -80))
        ...
        beaconThresholdList2.append(BeaconThreshold(minor_id: 7, threshold: -70))
        beaconThresholdList2.append(BeaconThreshold(minor_id: 8, threshold: -75))
        beaconThresholdList2.append(BeaconThreshold(minor_id: 9, threshold: -80))
        var beaconThresholdList3: [BeaconThreshold] = []
        beaconThresholdList3.append(BeaconThreshold(minor_id: 1, threshold: -70))
        beaconThresholdList3.append(BeaconThreshold(minor_id: 2, threshold: -75))
        beaconThresholdList3.append(BeaconThreshold(minor_id: 3, threshold: -80))
        beaconThresholdList3.append(BeaconThreshold(minor_id: 4, threshold: -70))
        beaconThresholdList3.append(BeaconThreshold(minor_id: 5, threshold: -75))
        beaconThresholdList3.append(BeaconThreshold(minor_id: 6, threshold: -80))
    ...
    func testGetNavigationText_（失敗するとき）(){
        let retval1 = navigations.getNavigationText(route_id: 2)
